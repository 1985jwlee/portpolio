...
1. [문제 정의](#문제-정의)
1. [핵심 설계 원칙](#핵심-설계-원칙)
1. [대안 비교와 선택](#대안-비교와-선택)
1. [의사결정 프레임워크](#의사결정-프레임워크)
1. [다른 도메인에서의 적용](#다른-도메인에서의-적용)
...
이 프로젝트에서 적용한 설계 원칙은 게임에만 국한되지 않으며, 다른 도메인에도 적용 가능합니다.

#### 비게임 도메인 적용 사례: Coin Data API

**관련 프로젝트**: [Coin Data API](https://github.com/1985jwlee/portpolio_coindataapi)
